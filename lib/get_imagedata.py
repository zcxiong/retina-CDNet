...
def get_data_training(DRIVE_train_imgs_original,DRIVE_train_groudTruth, batch_h, batch_w):
    ...
    train_imgs = train_imgs[:,:,subheigth2:heigth-subheigth+subheigth2,subWidth2:width-subWidth+subWidth2]
    train_masks = train_masks[:,:,subheigth2:heigth-subheigth+subheigth2,subWidth2:width-subWidth+subWidth2]
...
#Load the original data and return the extracted patches for training/testing
def get_data_testing(DRIVE_test_imgs_original, DRIVE_test_groudTruth, DRIVE_test_border, batch_h, batch_w):
    ### test
    ...
    test_imgs = test_imgs[:,:,subheigth2:heigth-subheigth+subheigth2,subWidth2:width-subWidth+subWidth2]
    test_masks = test_masks[:,:,subheigth2:heigth-subheigth+subheigth2,subWidth2:width-subWidth+subWidth2]
    if DRIVE_test_border != "":
        test_borders = load_hdf5(DRIVE_test_border)
        test_borders = test_borders[:,:,subheigth2:heigth-subheigth+subheigth2,subWidth2:width-subWidth+subWidth2]
...
def extract_random(full_imgs,full_masks, patch_h,patch_w, N_patches, inside=True):
    if (N_patches%full_imgs.shape[0] != 0):
        print("N_patches: plase enter a multiple of the number of imgs")
        exit()
...
def pred_only_FOV_with_mask(data_imgs,data_masks,original_imgs_border_masks):
